...
import appkuis.kuiskorporat.kuis.repository.mtk

import appkuis.kuiskorporat.kuis.ui.main.MainActivity
import appkuis.kuiskorporat.kuis.ui.score.score_antonim
import appkuis.kuiskorporat.kuis.ui.score.score_mtk
import org.jetbrains.anko.startActivity

class Soal_Matematika : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            ...
            val contents = mtk.getDataContents(this)
            //Show Data
            showDataContents(contents)
        }
            ...
            if (currentPosition < dataSize - 1){
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(getString(R.string.yes)){dialog,_->
                        ...
                        startActivity<score_mtk>(
                            score_mtk.EXTRA_NICKNAME to nickname,
                            score_mtk.EXTRA_SCORE to totalScore.toInt()
                        )
                        dialog.dismiss()
                    }
                    .setNegativeButton(getString(R.string.no)){dialog,_->

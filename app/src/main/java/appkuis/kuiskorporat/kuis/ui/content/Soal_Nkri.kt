...
import appkuis.kuiskorporat.kuis.repository.NKRI

import appkuis.kuiskorporat.kuis.ui.main.MainActivity
import appkuis.kuiskorporat.kuis.ui.score.score_antonim
import appkuis.kuiskorporat.kuis.ui.score.score_nkri
import org.jetbrains.anko.startActivity

class Soal_Nkri : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            ...
            val contents = NKRI.getDataContents(this)
            //Show Data
            showDataContents(contents)
        }
            ...
            if (currentPosition < dataSize - 1){
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(getString(R.string.yes)){dialog,_->
                        ...
                        startActivity<score_nkri>(
                            score_nkri.EXTRA_NICKNAME to nickname,
                            score_nkri.EXTRA_SCORE to totalScore.toInt()
                        )
                        dialog.dismiss()
                    }
                    .setNegativeButton(getString(R.string.no)){dialog,_->

...
import appkuis.kuiskorporat.kuis.repository.UUD

import appkuis.kuiskorporat.kuis.ui.main.MainActivity
import appkuis.kuiskorporat.kuis.ui.score.score_antonim
import appkuis.kuiskorporat.kuis.ui.score.score_uud
import org.jetbrains.anko.startActivity

class Soal_Uud : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            ...
            val contents = UUD.getDataContents(this)
            //Show Data
            showDataContents(contents)
        }
            ...
            if (currentPosition < dataSize - 1){
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(getString(R.string.yes)){dialog,_->
                        ...
                        startActivity<score_uud>(
                            score_uud.EXTRA_NICKNAME to nickname,
                            score_uud.EXTRA_SCORE to totalScore.toInt()
                        )
                        dialog.dismiss()
                    }
                    .setNegativeButton(getString(R.string.no)){dialog,_->

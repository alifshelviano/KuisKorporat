...
import appkuis.kuiskorporat.kuis.repository.Bindo
import appkuis.kuiskorporat.kuis.repository.Bing
import appkuis.kuiskorporat.kuis.ui.main.MainActivity
import appkuis.kuiskorporat.kuis.ui.score.score_bing
import appkuis.kuiskorporat.kuis.ui.score.score_sinonim
import org.jetbrains.anko.startActivity

class Soal_Bahasa_ing : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            ...
            val contents = Bing.getDataContents(this)
            //Show Data
            showDataContents(contents)
        }
            ...
            if (currentPosition < dataSize - 1){
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(getString(R.string.yes)){dialog,_->
                        ...
                        startActivity<score_bing>(
                            score_bing.EXTRA_NICKNAME to nickname,
                            score_bing.EXTRA_SCORE to totalScore.toInt()
                        )
                        dialog.dismiss()
                    }
                    .setNegativeButton(getString(R.string.no)){dialog,_->

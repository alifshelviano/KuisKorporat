...
class Soal_Sinonim : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            ...
            val contents = Sinonim.getDataContents(this)
            //Show Data
            showDataContents(contents)
        }
            ...
            if (currentPosition < dataSize - 1){
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(getString(R.string.yes)){dialog,_->
                        ...
                        startActivity<score_sinonim>(
                            score_sinonim.EXTRA_NICKNAME to nickname,
                            score_sinonim.EXTRA_SCORE to totalScore.toInt()
                        )
                        dialog.dismiss()
                    }
                    .setNegativeButton(getString(R.string.no)){dialog,_->

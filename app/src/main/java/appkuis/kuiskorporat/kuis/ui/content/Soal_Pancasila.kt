...
import appkuis.kuiskorporat.kuis.adapter.ContentAdapter
import com.codepolitan.quizapp.databinding.ActivityContentBinding
import appkuis.kuiskorporat.kuis.model.Content

import appkuis.kuiskorporat.kuis.repository.Antonim
import appkuis.kuiskorporat.kuis.repository.Pancasila

import appkuis.kuiskorporat.kuis.ui.main.MainActivity
import appkuis.kuiskorporat.kuis.ui.score.score_antonim
import appkuis.kuiskorporat.kuis.ui.score.score_pancasila
import org.jetbrains.anko.startActivity

class Soal_Pancasila : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            ...
            val contents = Pancasila.getDataContents(this)
            //Show Data
            showDataContents(contents)
        }
            ...
            if (currentPosition < dataSize - 1){
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(getString(R.string.yes)){dialog,_->
                        ...
                        startActivity<score_pancasila>(
                            score_pancasila.EXTRA_NICKNAME to nickname,
                            score_pancasila.EXTRA_SCORE to totalScore.toInt()
                        )
                        dialog.dismiss()
                    }
                    .setNegativeButton(getString(R.string.no)){dialog,_->

...
import appkuis.kuiskorporat.kuis.ui.score.score_bindo
import appkuis.kuiskorporat.kuis.ui.score.score_deret
import org.jetbrains.anko.startActivity

class Soal_Bahasa_indo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            ...
            val contents = Bindo.getDataContents(this)
            //Show Data
            showDataContents(contents)
        }
            ...
            if (currentPosition < dataSize - 1){
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(getString(R.string.yes)){dialog,_->
                        ...
                        startActivity<score_bindo>(
                            score_bindo.EXTRA_NICKNAME to nickname,
                            score_bindo.EXTRA_SCORE to totalScore.toInt()
                        )
                        dialog.dismiss()
                    }
                    .setNegativeButton(getString(R.string.no)){dialog,_->

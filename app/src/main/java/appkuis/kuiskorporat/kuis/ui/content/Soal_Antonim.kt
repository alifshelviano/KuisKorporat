...
class Soal_Antonim : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            ...
            val contents = Antonim.getDataContents(this)
            //Show Data
            showDataContents(contents)
        }
            ...
            if (currentPosition < dataSize - 1){
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(getString(R.string.yes)){dialog,_->
                        ...
                        startActivity<score_antonim>(
                            score_antonim.EXTRA_NICKNAME to nickname,
                            score_antonim.EXTRA_SCORE to totalScore.toInt()
                        )
                        dialog.dismiss()
                    }
                    .setNegativeButton(getString(R.string.no)){dialog,_->

...
import appquizipa.codepolitan.quizapp.adapter.ContentAdapter
import com.codepolitan.quizapp.databinding.ActivityContentBinding
import appquizipa.codepolitan.quizapp.model.Content
import appquizipa.codepolitan.quizapp.repository.Repository1
import appquizipa.codepolitan.quizapp.ui.main.MainActivity
import appquizipa.codepolitan.quizapp.ui.score.ScoreActivity
import org.jetbrains.anko.startActivity

class ContentActivityA : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            ...
            val contents = Repository1.getDataContents(this)
            //Show Data
            showDataContents(contents)
        }
